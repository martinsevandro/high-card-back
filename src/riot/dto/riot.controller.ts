...
export class RiotController {
  ...
  async getLatestMatchDetails(
    ...
    const matchIdResponse = await this.riotService.getLastMatchId(puuid, server);
    ...
    const matchDetails = await this.riotService.getMatchDetails(puuid, server, lastMatchId);
    return matchDetails;
  }
